...
import { ArrowDownWideNarrow, Phone, Search, UserPlus } from 'lucide-react'
...
export default function FriendsTab() {
  const { friends, tiers, showPaused } = useStore()
  const ui = useUi()
  ...
  const list = useMemo(() => {
    ...
    return sorted
  }, [friends, tiers, query, sort, tierFilter, showPaused])
